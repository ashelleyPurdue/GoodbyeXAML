...
namespace CodeGeneratorTests
{
    public class ExtensionMethodGeneratorTests
    {
        ...
        public void ClassWithProperties_Works()
        {
            ...
            string actual = CodeGenerator.GenerateExtensionClassFor("Foo", typeof(ClassWithProperties))
                .NormalizeWhitespace();
        ...
        public void ClassWithEvents_Works()
        {
            ...
            string actual = CodeGenerator.GenerateExtensionClassFor("Foo", typeof(ClassWithEvents))
                .NormalizeWhitespace();
